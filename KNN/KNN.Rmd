...
h1_test$predict_cxl_rate <- knn.reg(train = scale(h1_trn_x), test = scale(h1_tst_x), y = h1_trn_y, k = 40)$pred
# k = 1, 2, ..., 40, 50, it seems like K=40 has generally better results. 
eval(h1_test)
```
...
h2_test$predict_cxl_rate <- knn.reg(train = scale(h2_trn_x), test = scale(h2_tst_x), y = h2_trn_y, k = 50)$pred
# k = 1, 2, ..., 40, 50, it seems like K=50 has generally better results. 
eval(h2_test)
```
...
h2_test$predict_cxl_rate <- knn.reg(train = scale(h2_trn_x), test = scale(h2_tst_x), y = h2_trn_y, k = 40)$pred
# k = 1, 2, ..., 40, 50, it seems like K=40 has generally better results. 
eval(h2_test)
```
