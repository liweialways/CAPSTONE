...
+ group 1: other 22, business travel agencies 130, membership marketing 260
+ group 2: corporate 1266, unfenced 124
+ group 3: group 3524
+ group 4: government 199, fenced 124, opaque 78

```{r}
#Create this group

h1_train_3 <- h1_train %>%
      mutate(prod_group_cxl_rate = case_when(product_type == 'OPAQUE' ~ 'GOV/FEN/OP',
                                         product_type == 'FENCED' ~ 'GOV/FEN/OP',
                                         product_type == 'CORPORATE' ~ 'CORP/UNFEN',
                                         product_type == 'BUSINESS TRAVEL AGENCIES' ~ 'OTH/BTA/MEMB',
...
+ Government 112
+ BTA 829, unfenced 3012
+ coporate 3113, membership marketing 882, wholesale 695
+ group 2830
+ tactical marketing 99,other 2, opaque 761, fenced 170
