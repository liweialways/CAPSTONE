...
mod1_4 <- lm(formula=log(OTB_cxl_rate)~days_prior+cummulative_cxl_bookings+daily_gross_bookings+daily_cxl_bookings+price+day_of_week+month+prod_group_perc+prod_group_perc*days_prior+month*days_prior, data = h1_train, na.action=na.omit)
summary(mod1_4)
```
...
```{r}
mod1_5 <- lm(formula=log(OTB_cxl_rate)~days_prior+log(cummulative_gross_bookings)+daily_gross_bookings+daily_cxl_bookings+price+day_of_week+month+prod_group_perc+prod_group_perc*days_prior+month*days_prior, data = h1_train, na.action=na.omit)
summary(mod1_5)
```
...
mod2_4 <- lm(formula=log(OTB_cxl_rate)~days_prior+cummulative_cxl_bookings+daily_gross_bookings+daily_cxl_bookings+price+day_of_week+month+prod_group_perc+prod_group_perc*days_prior+month*days_prior, data = h2_train, na.action=na.omit)
summary(mod2_4)
```
...
```{r}
mod2_5 <- lm(formula=log(OTB_cxl_rate)~days_prior+log(cummulative_gross_bookings)+daily_gross_bookings+daily_cxl_bookings+price+day_of_week+month+prod_group_perc+prod_group_perc*days_prior+month*days_prior, data = h2_train, na.action=na.omit)
summary(mod2_5)

```

+This creates the best R^2 of .5966. 
