...
```{r}
# MAE, MAPE, MASE
left_join(left_join(a_dp_grp1_wd_mae,a_dp_grp1_wd_mape, by=c("dp_range")), a_dp_grp1_wd_mase, by="dp_range") %>% 
...
```{r}
# MAE, MAPE, MASE
left_join(left_join(a_dp_grp2_wd_mae,a_dp_grp2_wd_mape, by=c("dp_range")), a_dp_grp2_wd_mase, by="dp_range")
...
```{r}
# MAE, MAPE, MASE
left_join(left_join(a_dp_grp3_wd_mae,a_dp_grp3_wd_mape, by=c("dp_range")), a_dp_grp3_wd_mase, by="dp_range") %>% 
  select(dp_range, meanAE, meanAPE, meanASE)
