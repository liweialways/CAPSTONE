...
```{r}
mod1_5 <- lm(formula=OTB_cxl_rate~exp(days_prior)+log(cummulative_gross_bookings)+price+day_of_week+month+prod_group_perc+prod_group_perc*days_prior+month*days_prior, data = h1_train, na.action=na.omit)
summary(mod1_5)
```
...
```{r}
mod2_5 <- lm(formula=log(OTB_cxl_rate)~days_prior+log(cummulative_gross_bookings)+price+day_of_week+month+prod_group_perc+prod_group_perc*days_prior+month*days_prior, data = h2_train, na.action=na.omit)
summary(mod2_5)
